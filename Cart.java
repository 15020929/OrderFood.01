...
import com.example.xuan.orderfood.Database.Database;
import com.example.xuan.orderfood.Model.Order;
import com.example.xuan.orderfood.Model.Request;
import com.example.xuan.orderfood.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlace = (FancyButton) findViewById(R.id.btnPlaceOrder);
    ...
    public void showAlertDialog() {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Cart.this, "Thank you, Your order has been submitted", Toast.LENGTH_SHORT).show();
                finish();
